 ...
 * @author Enrique
 */
public class frmPeliculaAgregar extends javax.swing.JFrame {
    ...
    public void rellenoComboClasifiacion(){
        ...
        try {
            ...
            Logger.getLogger(frmPeliculaAgregar.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            modeloGenero.setColumnIdentifiers(encabezadosTabla);
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 440, -1, -1));
...
//                    LLenando la bd con los valores de la tabla
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPeliculaAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPeliculaAgregar().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtCodigoPelicula;
