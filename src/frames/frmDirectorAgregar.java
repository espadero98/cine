 ...
 * @author Enrique
 */
public class frmDirectorAgregar extends javax.swing.JFrame {
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        ...
        if (id.isEmpty() && ac.isEmpty()) {
            ...
            try{
                ...
                actor.setDirector(ac);
                ControladorDirector.Agregar(actor);
                    System.out.println("Todo se ejecuto con exito");
                    
                } catch (ErrorPelicula ex) {
                    Logger.getLogger(frmDirectorAgregar.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDirectorAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDirectorAgregar().setVisible(true);
            }
        });
    }
