...
public class frmClasificacion extends javax.swing.JFrame {
    ...
    public void rellenoTabla(){
        String[] encabezadosTabla={"Código","Clasificacion"};
        modeloPeliculas=new DefaultTableModel();
        ArrayList<Clasificacion> asignaturas = new ArrayList();
        Object[] fila = new Object[5];
        
        try {
            asignaturas = ControladorClasificacion.Buscar();
            modeloPeliculas.setColumnIdentifiers(encabezadosTabla);
            Iterator<Clasificacion> peli = asignaturas.iterator();
...
//                    fila[4] = peli.next();
   ...
   public void limpiar(){
    ...
    private void lblEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEliminarMouseClicked
        Clasificacion peli=new Clasificacion();
        if(tblPelicula.getSelectedRow()!=-1){
            try {
                int seleccion;
                seleccion = tblPelicula.getSelectedRow();
                peli.setIdClasificacion(tblPelicula.getValueAt(seleccion, 0).toString());
                ControladorClasificacion.Eliminar(peli);
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        frmClasificacionAgregar add=new frmClasificacionAgregar();
        add.setVisible(true);
        ...
        if (id.isEmpty() && pelicula.isEmpty()) {
            JOptionPane.showMessageDialog(null, "rellene todos los campos por favor");
                ...
                try{
                    ...
                    actor.setClasificacion(pelicula);
                    ControladorClasificacion.Modificar(actor);
