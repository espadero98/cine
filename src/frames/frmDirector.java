...
public class frmDirector extends javax.swing.JFrame {
    ...
    public void rellenoTabla(){
        String[] encabezadosTabla={"Código","Director"};
...
//                    fila[4] = peli.next();
   ...
   public void limpiar(){
    ...
    private void lblEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEliminarMouseClicked
        Director peli=new Director();
        if(tblPelicula.getSelectedRow()!=-1){
            try {
                int seleccion;
                seleccion = tblPelicula.getSelectedRow();
                peli.setIdDirector(tblPelicula.getValueAt(seleccion, 0).toString());
                ControladorDirector.Eliminar(peli);
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        frmDirectorAgregar add=new frmDirectorAgregar();
        add.setVisible(true);
        ...
        if (id.isEmpty() && pelicula.isEmpty()) {
            JOptionPane.showMessageDialog(null, "rellene todos los campos por favor");
                ...
                try{
                    ...
                    actor.setIdDirector(id);
                    actor.setDirector(pelicula);
                    ControladorDirector.Modificar(actor);
