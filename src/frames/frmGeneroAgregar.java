 ...
 * @author Enrique
 */
public class frmGeneroAgregar extends javax.swing.JFrame {
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        ...
        if (id.isEmpty() && ac.isEmpty()) {
            ...
            try{
                ...
                actor.setGenero(ac);
                ControladorGenero.Agregar(actor);
                    JOptionPane.showMessageDialog(null,"Todo se ejecuto con exito");
                                        
                } catch (ErrorPelicula ex) {
                    Logger.getLogger(frmGeneroAgregar.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGeneroAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmGeneroAgregar().setVisible(true);
            }
        });
    }
