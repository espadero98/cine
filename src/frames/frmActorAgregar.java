 ...
 * @author Enrique
 */
public class frmActorAgregar extends javax.swing.JFrame {
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        ...
        if (id.isEmpty() && ac.isEmpty()) {
            ...
            try{
                ...
                actor.setIdActor(id);
                actor.setActor(ac);
                ControladorActor.Agregar(actor);
                    System.out.println("Todo se ejecuto con exito");
                    System.out.println("entrooo");
                    
                } catch (ErrorPelicula ex) {
                    Logger.getLogger(frmActorAgregar.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmActorAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmActorAgregar().setVisible(true);
            }
        });
    }
